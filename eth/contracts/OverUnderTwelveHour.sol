...
contract OverUnderTwelveHour {
    string public constant NAME = "OverUnderTwelveHour";
    // Duration the event will staty active after BETTING_PERIOD ends
    uint256 private constant EVENT_DURATION = 12 hours;
    // Duration the event will allow betting after contract deployment
    uint256 private constant BETTING_PERIOD = 12 hours;
    // Min bet value
