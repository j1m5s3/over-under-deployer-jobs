...
contract OverUnderTwentyFourHour {
    string public constant NAME = "OverUnderTwentyFourHour";
    // Duration the event will staty active after BETTING_PERIOD ends
    uint256 private constant EVENT_DURATION = 24 hours;
    // Duration the event will allow betting after contract deployment
    uint256 private constant BETTING_PERIOD = 24 hours;
    // Min bet value
