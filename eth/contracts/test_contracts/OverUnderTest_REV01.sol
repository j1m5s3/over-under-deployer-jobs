...
contract OverUnderTest {
    ...
    uint256 public overBettersBalance = 0;
    //balance of underBetters pool
    uint256 public underBettersBalance = 0;
    // balance of fee pool
    uint256 public feePoolBalance = 0;
    ...
    uint256 public payoutModifierCeiling = 2000000000000000000;
    ...
    */
    ...
    function isBettingOver() public view returns (bool) {
        if (block.timestamp > bettingClose) {
            return true;
        }
        else {
            return false;
